...
def plot_filterens(orig_img, enh_img): 
    ...
    ax[0,0].set_yticks([])
    ax[0,0].set_title('Original',fontsize=25)
    ax[1,0].imshow(enh_img[0], cmap='gray')
    ax[1,0].set_xticks([])
    ax[1,0].set_yticks([])
    ax[1,0].set_title('Enhanced',fontsize=25)


    ax[0,1].imshow(orig_img[1])
    ax[0,1].set_xticks([])
    ax[0,1].set_yticks([])
    ax[0,1].set_title('Original',fontsize=25)
    ax[1,1].imshow(enh_img[1], cmap='gray')
    ax[1,1].set_xticks([])
    ax[1,1].set_yticks([])
    ax[1,1].set_title('Enhanced',fontsize=25)

    ax[0,2].imshow(orig_img[2])
    ax[0,2].set_xticks([])
    ax[0,2].set_yticks([])
    ax[0,2].set_title('Original',fontsize=25)
    ax[1,2].imshow(enh_img[2], cmap='gray')
    ax[1,2].set_xticks([])
    ax[1,2].set_yticks([])
    ax[1,2].set_title('Enhanced',fontsize=25)
